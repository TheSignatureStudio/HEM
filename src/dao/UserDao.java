...
public class UserDao extends DataObject {
	...
	public String[] statusList = { "1=>정상", "0=>중지", "-2=>탈퇴", "-1=>삭제" };
	...
	public String[] statusListMsg = { "1=>list.user.status_list.1", "0=>list.user.status_list.0" };
	...
	public String[] guardianType = { "F=>부", "M=>모", "E=>기타" };
	...
	public void maskInfo(DataSet info) {
		if(this.isBlind) {
			...
			info.put("publish_no_conv", this.maskName(info.s("publish_no_conv"), 4, "○", 8));
			info.put("business_no_conv", this.maskName(info.s("business_no_conv"), 4, "○", 8));
			info.put("publish_mobile_conv", this.maskName(info.s("publish_mobile_conv"), 4, "○", 8));
			info.put("publish_nm", this.maskName(info.s("publish_nm"),1, "○", 3));
